...
public class PvpSumByAssignedLineIdFinder implements MyMapperByDupla<Double, String, String> { // TODO test with factory
	...
	public PvpSumByAssignedLineIdFinder(List<Linea> listOfLines, PropuestaNuestra propuesta, MyFactoryFromTo<List<Linea>, MyListOfAsignables<Linea>> retrieverFactory, MyFactoryFromTo<PropuestaNuestra, MyMapperByDupla<Double, Linea, String>> sumByLineFactory) {
